...
2.  **Admin UI:** In Administrate, customize the User Index to show these two % metrics as visual bars.
...
**After user completes onboarding form, they are logged in, by thus not being able to fill in form again**
**Unfinished form? How do I handle users losing session and coming back? They should be able to see a "continue your form" message**
